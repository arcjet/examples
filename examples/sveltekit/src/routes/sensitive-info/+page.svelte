...
<!-- TODO: Wire up form and server-side validation for sensitive info detection. Static HTML only for now. -->
...
<main class="page">
  <div class="section">
    ...
    <p class="typography-primary">
      This form uses
      <a href="https://docs.arcjet.com/sensitive-info/concepts" class="link">Arcjet's sensitive info detection</a>
      feature which is configured to detect credit card numbers. It can be configured to detect other types of sensitive information and custom patterns.
    </p>
      ...
      <div class="form-field">
        <label class="form-label">
          ...
          <textarea
            ...
            class="form-textarea"
            name="supportMessage"
            >{form?.supportMessage ?? "I ordered a hat from your store and would like to request a refund. My credit card number is 4111111111111111"}</textarea
          >
        </label>
        {#if form?.error}
  ...
  <!-- Updated to SvelteKit form actions -->
    <p class="typography-secondary">
      The
      <a
    href="https://github.com/arcjet/examples/blob/main/examples/sveltekit/src/routes/sensitive-info/+page.server.ts"
        target="_blank"
        rel="noreferrer"
        class="link"
      >
