...
export function meta() {
  return [
    { title: "Arcjet React Router example app" },
    {
      name: "description",
      content:
        "An example React Router application protected by Arcjet. Bot detection. Rate limiting. Email validation. Attack protection. Data redaction. A developer-first approach to security.",
    },
  ];
}
          ...
          <div className="header-end">
            ...
            >
              <svg
                ...
                role="img"
                viewBox="0 0 128 128"
                className="hamburger-menu-menu-icon"
                stroke="currentColor"
              >
                <path
                  d="M12 66H116"
              ...
              <svg
                ...
                role="img"
                viewBox="0 0 128 128"
                className="hamburger-menu-cancel-icon"
                stroke="currentColor"
              >
                <path
                  fillRule="evenodd"
            ...
            <PopoverTarget id="navigation" closeAtWidthPx={1024}>
              <ul className="navigation-links">
                ...
                <li>
                  <NavLink className="navigation-link" to="/bots">
                    Bot protection
                  </NavLink>
                </li>
                <li>
                  <NavLink className="navigation-link" to="/rate-limiting">
                    Rate limiting
                  </NavLink>
                </li>
                <li>
                  <NavLink className="navigation-link" to="/attack">
                    Attack protection
                  </NavLink>
                </li>
                <li>
                  <NavLink className="navigation-link" to="/sensitive-info">
                    Sensitive info
                  </NavLink>
                </li>
              </ul>
