import { detectBot, fixedWindow } from "@arcjet/react-router";
import { arcjet } from "~/lib/arcjet";
import type { Route } from "./+types/bots_.test";

// Add rules to the base Arcjet instance
const arcjetForBotDetection = arcjet
  .withRule(
    detectBot({
...
export async function loader(ctx: Route.LoaderArgs) {
  ...
  // about the request.
  const decision = await arcjetForBotDetection.protect(ctx);
