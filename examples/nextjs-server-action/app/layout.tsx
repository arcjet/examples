...
export const metadata: Metadata = {
  title: {
    default: "Arcjet Next.js server action form example app",
    template: `%s - Arcjet Next.js server action form example app`,
  },
  description:
        ...
        <header className="header">
          ...
          <div className="header-end">
            <a
              ...
              href="https://github.com/arcjet/example-nextjs-server-action"
              target="_blank"
              rel="noreferrer"
            >
              <svg
