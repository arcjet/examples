...
const requestSchema = z.object({
  ...
  // Caller-owned id only. Copied onto guardHooks({ sessionId }) and
  // cloudflareThinkContext({ context: { sessionId } }). Never minted.
  // Never toolCallId. Never a Durable Object name / id.
...
const MODEL_KEY_REQUIRED = "AI_GATEWAY_API_KEY or OPENAI_API_KEY is required";
