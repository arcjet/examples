 ...
 * ```
 */
export declare function guardTool<TTool extends ClaudeToolDefinition<any>>(client: ArcjetAgentClient, tool: TTool, policy: GuardToolPolicy<ClaudeToolInput<TTool>>): TTool;
//#endregion