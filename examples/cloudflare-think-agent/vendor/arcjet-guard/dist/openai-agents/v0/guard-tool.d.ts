 ...
 * ```
 */
export declare function guardTool<TInput = unknown, TTool extends OpenAIAgentsTool = OpenAIAgentsTool>(client: ArcjetAgentClient, tool: TTool, policy: GuardToolPolicy<TInput>): TTool;
//#endregion