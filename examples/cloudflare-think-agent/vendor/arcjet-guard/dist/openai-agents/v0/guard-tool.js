...
async function runGuardedTool(client, tool, policy, runContext, input, execute) {
	...
	const source = isContextSource(runContext) ? runContext : void 0;
	const agentCtx = openaiAgentsContext(source, sessionId === void 0 ? void 0 : { sessionId });
