 ...
 * ```
 */
export declare function guardTool<TInput, TOutput>(client: ArcjetAgentClient, tool: ToolDefinition<TInput, TOutput>, policy: GuardToolPolicy<TInput>): ToolDefinition<TInput, TOutput>;
//#endregion