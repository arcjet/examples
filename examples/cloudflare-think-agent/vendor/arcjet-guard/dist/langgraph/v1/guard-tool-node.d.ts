 ...
 * ```
 */
export declare function guardToolNode<T extends LangGraphToolNodeLike>(client: ArcjetAgentClient, node: T, policy?: GuardToolNodePolicy): T;
export declare function guardToolNode<T extends LangGraphTool>(client: ArcjetAgentClient, tools: readonly T[], policy?: GuardToolNodePolicy): T[];
//#endregion