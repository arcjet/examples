 ...
 * ```
 */
export declare function guardTool<TTool extends LangGraphTool<any>>(client: ArcjetAgentClient, tool: TTool, policy: GuardToolPolicy<LangGraphToolInput<TTool>>): TTool;
//#endregion