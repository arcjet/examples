...
function guardTool(client, tool, policy) {
	if (typeof policy.action === "string" && policy.action !== "") assertValidAction(policy.action, "guardTool");
...
async function runGuardedTool(client, tool, policy, input, config, execute) {
