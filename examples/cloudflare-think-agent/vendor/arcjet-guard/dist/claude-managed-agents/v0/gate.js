import { labelRejectedByService } from "../../agents/label.js";
...
async function runGate(client, params) {
	const { action, rules, correlationId, metadata, onAllow, onDeny, onUnavailable, onGuardError = "deny", actor, inputs } = params;
	...
	if (decision !== void 0) {
		...
		if (decision.conclusion === "ALLOW" && labelRejectedByService(decision)) warnUnavailable(action, "failed-open", false);
