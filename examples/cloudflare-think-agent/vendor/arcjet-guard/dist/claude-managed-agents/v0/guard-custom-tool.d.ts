 ...
 */
export interface GuardCustomToolPolicy<TInput = {
  [key: string]: unknown;
}> {
 ...
 * ```
 */
export declare function guardCustomTool<TOutput>(client: ArcjetAgentClient, call: GuardCustomToolCall<TOutput>, policy: GuardCustomToolPolicy): Promise<GuardCustomToolResult<TOutput>>;
export declare function guardCustomTool<TTool extends ManagedAgentsRunnableTool<any, any>>(client: ArcjetAgentClient, tool: TTool, policy: GuardCustomToolPolicy<Parameters<TTool["run"]>[0]>): TTool;
//#endregion