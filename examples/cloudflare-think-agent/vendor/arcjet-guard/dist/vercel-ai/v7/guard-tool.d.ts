 ...
 * ```
 */
export declare function guardTool<T extends Tool>(client: ArcjetAgentClient, tool: T, policy: GuardToolPolicy<T>): Tool<InferToolInput<T>, InferToolOutput<T>, ArcjetAgentContext | undefined>;
//#endregion
export type { ArcjetDenialResult };