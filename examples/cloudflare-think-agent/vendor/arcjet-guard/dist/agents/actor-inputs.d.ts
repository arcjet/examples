...
//#region src/agents/actor-inputs.d.ts
/**
 ...
 */
export type ActorResolver<TArgs extends readonly unknown[]> = string | ((...args: TArgs) => string | Promise<string>);
/**
 * Typed remote-policy inputs, or a resolver over the adapter's native call.
 * Build each value with {@link ../policy-input.ts}.
 */
export type InputsResolver<TArgs extends readonly unknown[]> = PolicyInputMap | ((...args: TArgs) => PolicyInputMap | Promise<PolicyInputMap>);
 ...
 */
export declare function resolveActorInputs<TArgs extends readonly unknown[]>(policy: ActorInputsPolicy<TArgs>, ...args: TArgs): Promise<{
  actor?: string;
