 ...
 * ```
 */
export declare function guardTool<TTool extends LangChainTool<any>>(client: ArcjetAgentClient, tool: TTool, policy: GuardToolPolicy<LangChainToolInput<TTool>>): TTool;
//#endregion