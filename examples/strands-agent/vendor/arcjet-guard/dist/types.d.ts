 ...
 */
import type { DetectSensitiveInfoFunction, SensitiveInfoEntities, SensitiveInfoResult } from "@arcjet/analyze";
...
export type RuleResult = RuleResultTokenBucket | RuleResultFixedWindow | RuleResultSlidingWindow | RuleResultPromptInjection | RuleResultModerateContent | RuleResultSensitiveInfo | RuleResultCustom | RuleResultNotRun | RuleResultError | RuleResultInputConstraint | RuleResultUnknown;
/**
