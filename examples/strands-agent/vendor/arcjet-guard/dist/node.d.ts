 ...
 */
export { type Conclusion, type Billing, type Reason, type Mode, type RuleResult, type RuleResultTokenBucket, type RuleResultFixedWindow, type RuleResultSlidingWindow, type RuleResultPromptInjection, type RuleResultModerateContent, type RuleResultSensitiveInfo, type RuleResultCustom, type RuleResultNotRun, type RuleResultError, type RuleResultUnknown, type Decision, type DecisionAllow, type DecisionDeny, type DecisionBase, type RuleWithInput, type RuleWithConfig, type CaptureOptions, type GuardOptions, type DiagnosticLogger, type LaunchOptions, type ArcjetGuard, type PolicyEvaluation, type PolicyInput, type PolicyInputMap, type PolicyRuleResult, type RuleResultInputConstraint, type StringMatchOperator, type TokenBucketConfig, type TokenBucketInput, type FixedWindowConfig, type FixedWindowInput, type SlidingWindowConfig, type SlidingWindowInput, type DetectPromptInjectionConfig, type DetectPromptInjectionInput, type ModerateContentConfig, type ModerateContentInput, type ExperimentalModerateContentConfig, type ExperimentalModerateContentInput, type LocalDetectSensitiveInfoConfig, type LocalDetectSensitiveInfoInput, type SensitiveInfoEntityType, type SensitiveInfoBackend, type SensitiveInfoBackendContext, type SensitiveInfoBackendOptions, type SensitiveInfoBackendLogger, type LocalCustomConfig, type LocalCustomInput, tokenBucket, fixedWindow, slidingWindow, detectPromptInjection, moderateContent, localDetectSensitiveInfo, defineCustomRule, policyInput, launchArcjetWithTransport, registerArcjet, unregisterArcjet, guard, capture, flush, _launchWithTransportFactory, } from "./index.ts";
 ...
 * ```
 */
export declare function launchArcjet(options: LaunchOptions): ArcjetGuard;
