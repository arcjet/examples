 ...
 * @internal
 */
export const symbolArcjetDiagnostics = Symbol.for("arcjet.guard.diagnostics");
 ...
 */
export function createDiagnosticHandler(options = {}) {
    ...
    function diagnose(diagnostic) {
        try {
            ...
            const total = held === undefined && diagnostic.count === undefined
                ? undefined
