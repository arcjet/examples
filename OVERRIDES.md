...
| `nextjs-ai-agent` | `@workflow/core > nanoid: 5.1.16` | Workflow 4.8.3 pins nanoid 5.1.6. Remove when Workflow permits nanoid 5.1.16 or later. | [GHSA-28wg-ghj8-5hjv](https://github.com/advisories/GHSA-28wg-ghj8-5hjv), [GHSA-xwg4-73v4-xw9w](https://github.com/advisories/GHSA-xwg4-73v4-xw9w) |
| `nextjs-ai-agent` | `@workflow/world-local` and `@workflow/world-vercel > undici: 7.29.0` | Workflow world adapters pin undici 7.28.0. Remove when both permit undici 7.29.0 or later. | [GHSA-4cwx-7wf7-3272](https://github.com/advisories/GHSA-4cwx-7wf7-3272), [GHSA-8xcm-r25x-g524](https://github.com/advisories/GHSA-8xcm-r25x-g524), [GHSA-jr45-8vmc-qm54](https://github.com/advisories/GHSA-jr45-8vmc-qm54), [GHSA-m8rv-5g2x-5cg5](https://github.com/advisories/GHSA-m8rv-5g2x-5cg5), [GHSA-v3r7-h72x-cjcm](https://github.com/advisories/GHSA-v3r7-h72x-cjcm) |
...
| `nextjs-guard-policy` | `sharp: 0.35.4` | Rampart uses Transformers 4.2.0, which requires sharp 0.34.x. Remove when Transformers permits sharp 0.35.0 or later. | [GHSA-f88m-g3jw-g9cj](https://github.com/advisories/GHSA-f88m-g3jw-g9cj), [GHSA-rgj7-g3m4-5g8c](https://github.com/advisories/GHSA-rgj7-g3m4-5g8c) |
| `nextjs-sensitive-info` | `sharp: 0.35.4` | Rampart uses Transformers 4.2.0, which requires sharp 0.34.x. Remove when Transformers permits sharp 0.35.0 or later. | [GHSA-f88m-g3jw-g9cj](https://github.com/advisories/GHSA-f88m-g3jw-g9cj), [GHSA-rgj7-g3m4-5g8c](https://github.com/advisories/GHSA-rgj7-g3m4-5g8c) |
| `node-guard-policy` | `sharp: 0.35.4` | Rampart uses Transformers 4.2.0, which requires sharp 0.34.x. Remove when Transformers permits sharp 0.35.0 or later. | [GHSA-f88m-g3jw-g9cj](https://github.com/advisories/GHSA-f88m-g3jw-g9cj), [GHSA-rgj7-g3m4-5g8c](https://github.com/advisories/GHSA-rgj7-g3m4-5g8c) |
| `firebase-functions` | `@google-cloud/pubsub > @opentelemetry/core: 2.11.0` | Pub/Sub 5.3.1 pins core 1.x but uses the compatible W3CTraceContextPropagator API. Remove when Pub/Sub permits core 2.8.0 or later. | [GHSA-8988-4f7v-96qf](https://github.com/advisories/GHSA-8988-4f7v-96qf) |
| `google-adk-agent` | `adm-zip: 0.6.0` | Google ADK 2.0.0 requires adm-zip ^0.5.17. Remove when ADK permits adm-zip 0.6.0 or later. [GHSA-vwc7-r8mq-g2x9](https://github.com/advisories/GHSA-vwc7-r8mq-g2x9) remains unpatched in 0.6.0. | [GHSA-xcpc-8h2w-3j85](https://github.com/advisories/GHSA-xcpc-8h2w-3j85) |
| `nextjs-guard-policy` | `adm-zip: 0.6.0` | Rampart uses ONNX Runtime, whose installer pins adm-zip 0.5.x. Remove when ONNX Runtime permits adm-zip 0.6.0 or later. [GHSA-vwc7-r8mq-g2x9](https://github.com/advisories/GHSA-vwc7-r8mq-g2x9) remains unpatched in 0.6.0. | [GHSA-xcpc-8h2w-3j85](https://github.com/advisories/GHSA-xcpc-8h2w-3j85) |
| `nextjs-sensitive-info` | `adm-zip: 0.6.0` | Rampart uses ONNX Runtime, whose installer pins adm-zip 0.5.x. Remove when ONNX Runtime permits adm-zip 0.6.0 or later. [GHSA-vwc7-r8mq-g2x9](https://github.com/advisories/GHSA-vwc7-r8mq-g2x9) remains unpatched in 0.6.0. | [GHSA-xcpc-8h2w-3j85](https://github.com/advisories/GHSA-xcpc-8h2w-3j85) |
| `node-guard-policy` | `adm-zip: 0.6.0` | Rampart uses ONNX Runtime, whose installer pins adm-zip 0.5.x. Remove when ONNX Runtime permits adm-zip 0.6.0 or later. [GHSA-vwc7-r8mq-g2x9](https://github.com/advisories/GHSA-vwc7-r8mq-g2x9) remains unpatched in 0.6.0. | [GHSA-xcpc-8h2w-3j85](https://github.com/advisories/GHSA-xcpc-8h2w-3j85) |
| `firebase-functions` | `firebase-tools > csv-parse: 7.0.2` | Firebase Tools pins csv-parse 5.x. Its named parse streaming API remains compatible. Remove when Firebase Tools permits 7.0.2 or later. | [GHSA-8cw4-87c7-c6xx](https://github.com/advisories/GHSA-8cw4-87c7-c6xx) |
| `nestjs` | `@nestjs/platform-express > multer: 2.3.0` | Nest platform-express 11.2.1 and latest 12.0.1 pin multer 2.2.0. Remove when the parent permits multer 2.3.0 or later. | [GHSA-535w-7cp7-47q4](https://github.com/advisories/GHSA-535w-7cp7-47q4), [GHSA-qfvm-cv95-jqjf](https://github.com/advisories/GHSA-qfvm-cv95-jqjf), [GHSA-qvfw-j98x-7q72](https://github.com/advisories/GHSA-qvfw-j98x-7q72), [GHSA-wc9g-mqfw-jrwm](https://github.com/advisories/GHSA-wc9g-mqfw-jrwm) |
