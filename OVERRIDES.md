...
| `firebase-functions` | `@opentelemetry/core: 2.11.0` | Pub/Sub 5.3.1 pins core 1.x but uses the compatible W 3CTraceContextPropagator API. Remove when Pub/Sub permits core 2.8.0 or later. | [GHSA-8988-4f7v-96qf](https://github.com/advisories/GHSA-8988-4f7v-96qf) |
| `google-adk-agent` | `adm-zip: 0.6.0` | Google ADK 2.0.0 pins adm-zip 0.5.16. Remove when ADK permits adm-zip 0.6.0 or later. GHSA-vwc 7-r 8mq-g 2x 9 remains unpatched in 0.6.0. | [GHSA-xcpc-8h2w-3j85](https://github.com/advisories/GHSA-xcpc-8h2w-3j85) |
| `nextjs-guard-policy` | `adm-zip: 0.6.0` | Rampart uses ONNX Runtime, whose installer pins adm-zip 0.5.x. Remove when ONNX Runtime permits adm-zip 0.6.0 or later. GHSA-vwc 7-r 8mq-g 2x 9 remains unpatched in 0.6.0. | [GHSA-xcpc-8h2w-3j85](https://github.com/advisories/GHSA-xcpc-8h2w-3j85) |
| `nextjs-sensitive-info` | `adm-zip: 0.6.0` | Rampart uses ONNX Runtime, whose installer pins adm-zip 0.5.x. Remove when ONNX Runtime permits adm-zip 0.6.0 or later. GHSA-vwc 7-r 8mq-g 2x 9 remains unpatched in 0.6.0. | [GHSA-xcpc-8h2w-3j85](https://github.com/advisories/GHSA-xcpc-8h2w-3j85) |
| `node-guard-policy` | `adm-zip: 0.6.0` | Rampart uses ONNX Runtime, whose installer pins adm-zip 0.5.x. Remove when ONNX Runtime permits adm-zip 0.6.0 or later. GHSA-vwc 7-r 8mq-g 2x 9 remains unpatched in 0.6.0. | [GHSA-xcpc-8h2w-3j85](https://github.com/advisories/GHSA-xcpc-8h2w-3j85) |
| `firebase-functions` | `csv-parse: 7.0.2` | Firebase Tools pins csv-parse 5.x. Its named parse streaming API remains compatible. Remove when Firebase Tools permits 7.0.2 or later. | [GHSA-8cw4-87c7-c6xx](https://github.com/advisories/GHSA-8cw4-87c7-c6xx) |
| `nestjs` | `multer: 2.3.0` | Nest platform-express 11.2.1 and latest 12.0.1 pin multer 2.2.0. Remove when the parent permits multer 2.3.0 or later. | [GHSA-535w-7cp7-47q4](https://github.com/advisories/GHSA-535w-7cp7-47q4), [GHSA-qfvm-cv95-jqjf](https://github.com/advisories/GHSA-qfvm-cv95-jqjf), [GHSA-qvfw-j98x-7q72](https://github.com/advisories/GHSA-qvfw-j98x-7q72), [GHSA-wc9g-mqfw-jrwm](https://github.com/advisories/GHSA-wc9g-mqfw-jrwm) |
